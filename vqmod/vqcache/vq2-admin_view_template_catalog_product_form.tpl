      ...
      <div class="panel-body">
        ...
        <?php } ?>
                  ...
                  <tfoot>
                    <tr>
                      <td colspan="2"></td>
                      <td class="text-left"><?php if ($pim_status){?><a type="button" data-toggle="manager" title="选择图片" class="btn btn-success"><i class="fa fa-upload"></i> 批量添加图片 </a>&nbsp;<?php } ?><button type="button" onclick="addImage();" data-toggle="tooltip" title="<?php echo $button_image_add; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button></td>
                    </tr>
                  </tfoot>
                </table>
              </div>
