          ...
          <div class="row">
            <div class="col-sm-6">
              ...
              <div class="form-group">
                ...
                <input type="text" name="filter_customer" value="<?php echo $filter_customer; ?>" placeholder="<?php echo $entry_author; ?>" id="input-author" class="form-control" />
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'op.name') { ?>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($review['order_product_review_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $review['order_product_review_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $review['order_product_review_id']; ?>" />
                    <?php } ?></td>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=catalog/oreview&token=<?php echo $token; ?>';
