      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-qq-login" class="form-horizontal">
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="qq_login_client_id" value="<?php echo $qq_login_client_id; ?>" placeholder="<?php echo $entry_client_id; ?>" id="entry-client_id" class="form-control"/>
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="qq_login_secret" value="<?php echo $qq_login_secret; ?>" placeholder="<?php echo $entry_secret; ?>" id="entry-secret" class="form-control"/>
              <?php if ($error_secret) { ?>
          ...
          <div class="form-group hidden">
            ...
            <div class="col-sm-10">
              <select name="qq_login_debug" id="input-logging" class="form-control">
                <?php if ($qq_login_debug) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="qq_login_customer_group_id" id="input-customer-group" class="form-control">
                <?php foreach ($customer_groups as $customer_group) { ?>
                <?php if ($customer_group['customer_group_id'] == $qq_login_customer_group_id) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" id="return-url" name="qq_login_return_url" value="<?php echo $qq_login_return_url; ?>" class="form-control" />
            </div>
          </div>
          <div class="form-group">
