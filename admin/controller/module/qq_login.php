...
class ControllerModuleQQLogin extends Controller {
	...
	public function index() {
		$this->language->load('module/qq_login');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('module/qq_login', 'token=' . $this->session->data['token'], 'SSL')
		);

		$data['action'] = $this->url->link('module/qq_login', 'token=' . $this->session->data['token'], 'SSL');

		$data['cancel'] = $this->url->link('extension/module', 'token=' . $this->session->data['token'], 'SSL');

		if (isset($this->request->post['qq_login_client_id'])) {
			$data['qq_login_client_id'] = $this->request->post['qq_login_client_id'];
		} else {
			$data['qq_login_client_id'] = $this->config->get('qq_login_client_id');
		}

		if (isset($this->request->post['qq_login_secret'])) {
			$data['qq_login_secret'] = $this->request->post['qq_login_secret'];
		} else {
			$data['qq_login_secret'] = $this->config->get('qq_login_secret');
		}

		if (isset($this->request->post['qq_login_debug'])) {
			$data['qq_login_debug'] = $this->request->post['qq_login_debug'];
		} else {
			$data['qq_login_debug'] = $this->config->get('qq_login_debug');
		}
		...
		if (isset($this->request->post['qq_login_customer_group_id'])) {
			$data['qq_login_customer_group_id'] = $this->request->post['qq_login_customer_group_id'];
		} else {
			$data['qq_login_customer_group_id'] = $this->config->get('qq_login_customer_group_id');
		}

		if (isset($this->request->post['qq_login_return_url'])) {
			$data['qq_login_return_url'] = $this->request->post['qq_login_return_url'];
		} else {
			$data['qq_login_return_url'] = $this->config->get('qq_login_return_url');
		}
		//$data['return_url'] = HTTPS_CATALOG . 'index.php?route=module/qq_login/login';
		...
		$this->response->setOutput($this->load->view('module/qq_login.tpl', $data));
	}
	...
	protected function validate() {
		...
		if (!$this->request->post['qq_login_client_id']) {
			$this->error['client_id'] = $this->language->get('error_client_id');
		}

		if (!$this->request->post['qq_login_secret']) {
	...
	public function install() {
		...
		$this->model_extension_event->addEvent('qq_login', 'post.customer.logout', 'module/qq_login/logout');
	}
