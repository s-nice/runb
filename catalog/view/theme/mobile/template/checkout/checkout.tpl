...
$(document).delegate('#button-payment-method', 'click', function() {
    $.ajax({
        ...
        success: function(json) {
            ...
            } else if ($('#collapse-payment-method input[name=\'agree\']').length && !$('#collapse-payment-method input[name=\'agree\']').is(':checked')) {
                $('#collapse-payment-method .panel-body').prepend('<div class="alert alert-warning">' + '警告：必须同意条款才可以继续结账！' + '<button type="button" class="close" data-dismiss="alert">&times;</button></div>');
                $('#button-payment-method').button('reset');
            } else {
                $.ajax({
                    ...
                    success: function(html) {
                        $('#collapse-checkout-confirm .panel-body').html(html + '<div class="buttons"><div class="pull-right"><input id="button-proconfirm" type="button" value="确认" id="button-payment-method" data-loading-text="" class="btn btn-primary"></div></div>');
...
$(document).delegate('#button-proconfirm', 'click', function() {
		$.ajax({
				...
				success: function(html) {
				  	$('#collapse-checkout-confirm .panel-body').html($('#collapse-checkout-confirm .panel-body').html() + '<div class="hidden">' + html + '</div>');
